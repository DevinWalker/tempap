...
(function () {
	...
	if (k = "https://js.stripe.com", f = "https://js.stripe.com", g = !!/stripe\.com$/.test("undefined" != typeof window && null !== window ? window.location.host : void 0), e = "console" in window && "warn" in window.console, d = function d() {
		var a;
		...
		return a.version = 2, a.endpoint = "https://api.stripe.com/v1", a.StripeV3 = null, a.setPublishableKey = function (b) {
			...
			var c, d, e, f;
			for (this._iframeChannelStatus = b ? "success" : "failure", "failure" === this._iframeChannelStatus && this._fallBackToOldStripeJsTechniques(), d = this._iframeRequestQueue, delete this._iframeRequestQueue, this._iframeRequestQueue = [], e = 0, f = d.length; e < f; e++) {
			...
			var d, e, f;
			if (b.data || (b.data = {}), e = "POST" === b.method && "object" == _typeof(null != (f = b.data) ? f.card : void 0), c || (null != b.data.payment_user_agent ? this._isChannel || (b.data.payment_user_agent = "" + b.data.payment_user_agent + " (" + a.stripejs_ua + ")") : b.data.payment_user_agent = a.stripejs_ua), "iframe" === this._transport) {
			...
			var b, c, d, e, f;
			for (c = {}, f = this._resourceTimingWhitelist, d = 0, e = f.length; d < e; d++) {
				b = f[d], a[b] && (c[b] = a[b]);
			}return c;
		}, a.logRUM = function (b) {
	...
	for (this.Stripe = a, this.Stripe.token = function () {
		...
		return b.validate = function (a, b) {
			...
			if ("object" != (typeof a === "undefined" ? "undefined" : _typeof(a))) throw b + " invalid";
		}, b.formatData = function (b, c) {
			var d, e, f;
			a.utils.isElement(b) && (b = a.utils.paramsFromForm(b, c));
			for (d in b) {
				e = b[d], null == e && delete b[d];
		...
		return o(c, b), c.tokenName = "card", c.whitelistedAttrs = ["number", "cvc", "exp", "exp_month", "exp_year", "name", "address_line1", "address_line2", "address_city", "address_state", "address_zip", "address_country", "currency"], c.createToken = function (b, e, f) {
			var g, h;
			if (null == e && (e = {}), a.token.validate(b, "card"), "function" == typeof e ? (f = e, e = {}) : "object" != (typeof e === "undefined" ? "undefined" : _typeof(e)) && (g = parseInt(e, 10), e = {}, g > 0 && (e.amount = g)), b._fields && b.createToken) return b.createToken(f);
		...
		return o(c, b), c.tokenName = "bank_account", c.whitelistedAttrs = ["country", "currency", "routing_number", "account_number", "name", "account_holder_type", "account_holder_name"], c.createToken = function (b, d, e) {
			...
			var b, c, d, e, f, g;
			for (d = 0, b = (a + "").split(""), g = [0, 3, 6], e = 0, f = g.length; e < f; e++) {
		...
		return b.create = function (b, c) {
			var d;
			if ("object" != (typeof b === "undefined" ? "undefined" : _typeof(b))) throw new Error("params must be an object.");
			...
			}, f = new a.easyXDM.Socket({ swf: "" + a._iframeBaseUrl + "/v2/stripexdm.swf", remote: b, onMessage: e, container: c }), null;
		}, b;
	...
	}(), c = ["createToken", "getToken", "cardType", "validateExpiry", "validateCVC", "validateCardNumber"], l = 0, m = c.length; l < m; l++) {
		h = c[l], this.Stripe[h] = this.Stripe.card[h];
		...
		"function" == typeof window.addEventListener && window.addEventListener("message", function (b) {
			...
			try {
				...
				for (f in c) {
					i = c[f], d += "" + f + "=" + encodeURIComponent(i) + "&";
	...
	this.Stripe.isDoubleLoaded || function (a) {
		function b(a, e) {
			...
			var g = a.Number || d.Number,
			    ...
			    m = a.Math || d.Math,
			    n = a.JSON || d.JSON;
			"object" == (typeof n === "undefined" ? "undefined" : _typeof(n)) && n && (e.stringify = n.stringify, e.parse = n.parse);
			var _o,
			    _p,
			    q,
			    r = i.prototype,
			...
			if (!f("json")) {
				...
				if ((_o = r.hasOwnProperty) || (_o = function o(a) {
					var b,
					    c = {};
					return (c.__proto__ = null, c.__proto__ = { toString: 1 }, c).toString != s ? _o = function o(a) {
					...
					var F = { 92: "\\\\", 34: '\\"', 8: "\\b", 12: "\\f", 10: "\\n", 13: "\\r", 9: "\\t" },
						...
						if ("object" == (typeof h === "undefined" ? "undefined" : _typeof(h)) && h) if (i = s.call(h), i != w || _o.call(h, "toJSON")) "function" == typeof h.toJSON && (i != x && i != y && i != z || _o.call(h, "toJSON")) && (h = h.toJSON(a));else if (h > -1 / 0 && h < 1 / 0) {
							if (E) {
						...
						if (i == y) return J("" + h);
						if ("object" == (typeof h === "undefined" ? "undefined" : _typeof(h))) {
							for (G = g.length; G--;) {
								if (g[G] === h) throw l();
					...
					e.stringify = function (a, b, d) {
						var e, f, g, h;
						if (c[typeof b === "undefined" ? "undefined" : _typeof(b)] && b) if ((h = s.call(b)) == v) f = b;else if (h == z) {
							g = {};
					...
					var L,
						...
						for (var a, b, c, d, e, f = M, g = f.length; L < g;) {
							switch (e = f.charCodeAt(L)) {
								...
								case 34:
									for (a = "@", L++; L < g;) {
										if (e = f.charCodeAt(L), e < 32) P();else if (92 == e) switch (e = f.charCodeAt(++L)) {
											case 92:
											case 34:
											case 47:
											case 98:
						...
						var d,
						    e = a[b];
						if ("object" == (typeof e === "undefined" ? "undefined" : _typeof(e)) && e) if (s.call(e) == z) for (d = e.length; d--;) {
							S(e, d, c);
	...
	this.Stripe.isDoubleLoaded || !function (a, b, c, d, e, f) {
		...
		function h() {
			...
			if (!p(navigator.plugins) && "object" == _typeof(navigator.plugins[a])) {
		...
		function o(a, b) {
			...
			var e,
			    g = [];
			for (var h in b) {
				b.hasOwnProperty(h) && (e = "stripe_" + h, g.push(e + "=" + f(b[h])));
		...
		function q(a, b, c) {
			var d;
			for (var e in b) {
				b.hasOwnProperty(e) && (e in a ? (d = b[e], "object" == (typeof d === "undefined" ? "undefined" : _typeof(d)) ? q(a[e], d, c) : c || (a[e] = b[e])) : a[e] = b[e]);
			}return a;
		}
		...
		function u(a) {
			for (var b, c = {
				incoming: function incoming(a, b) {
					this.up.incoming(a, b);
				}, outgoing: function outgoing(a, b) {
		...
		var w,
		    ...
		    I = "stripeXDM_",
		    J = !1;
		if (g(a, "addEventListener")) z = function z(a, b, c) {
		...
		var O = function (a) {
			...
			for (var b, c = {}, d = a.length; d--;) {
				b = a[d].split("="), c[b[0].replace(/^stripe_/, "")] = e(b[1]);
			}return c;
		}(/stripe_xdm_e=/.test(c.search) ? c.search : c.hash),
		    P = function P() {
			return Stripe.JSON;
		};
		q(H, { version: "2.4.19.3", query: O, stack: {}, apply: q, getJSONObject: P, whenReady: j }), H.DomHelper = { on: z, un: A }, function () {
			var a = {};
			H.Fn = {
			...
			var b = u(t(a).concat([{
				incoming: function incoming(b, c) {
					a.onMessage(b, c);
			...
			function g(c) {
				...
				H.Fn.set("flash_loaded" + c.replace(/[\-.]/g, "_"), function () {
					...
					for (var a = H.stack.FlashTransport[c].queue, b = 0; b < a.length; b++) {
						a[b]();
					}a.length = 0;
					...
					right: 0,
					top: 0
				} : { height: "1px", width: "1px", position: "absolute", overflow: "hidden", right: 0, top: 0 }), b.body.appendChild(t));
			...
			var h, i, p, r, t;
			return h = {
				outgoing: function outgoing(b, c, d) {
			...
			var g, h, i, k;
			return g = {
				outgoing: function outgoing(a, c, d) {
					try {
				...
				init: function init() {
					...
					if (m) {
						for (; 0 !== d.length;) {
							...
							h.push({ data: j.length + "_" + i, origin: e, callback: 0 === j.length ? g : null });
						}
	...
	this.Stripe.isDoubleLoaded || (a = function () {
		function a(a, b, f, g) {
			...
			}(this), o = ["oncancel", "onpaymentauthorized", "onpaymentmethodselected", "onshippingcontactselected", "onshippingmethodselected", "onvalidatemerchant"], l = 0, m = o.length; l < m; l++) {
				h = o[l], j(h);
	...
	this.Stripe.isDoubleLoaded || (this.Stripe.utils = function () {
		...
		return c = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, b.trim = function (a) {
			...
			try {
				for (e in a) {
					f = a[e], c && (e = "" + c + "[" + e + "]"), "object" == (typeof f === "undefined" ? "undefined" : _typeof(f)) ? this.serialize(f, b, e) : b.push("" + e + "=" + encodeURIComponent(f));
			...
			return "object" == (typeof a === "undefined" ? "undefined" : _typeof(a)) && (!!a.jquery || 1 === a.nodeType);
			...
			for (null == c && (c = []), b.jquery && (b = b[0]), f = b.getElementsByTagName("input"), h = b.getElementsByTagName("select"), i = {}, j = 0, l = f.length; j < l; j++) {
				...
				g = h[k], d = this.underscore(g.getAttribute("data-stripe")), a.call(c, d) < 0 || null != g.selectedIndex && (i[d] = g.options[g.selectedIndex].value);
			}return i;
			...
			}, "string" != typeof a && g(), f = a.split(/[\.\-\/\s]+/g), 2 !== f.length && g(), b = i = 0, j = f.length; i < j; b = ++i) {
	...
	a = new Date().getTime(), this.Stripe.isDoubleLoaded || (this.Stripe.ajaxJSONP = function (c) {
		var d, e, f, g, h, i, j;
		return null == c && (c = {}), f = "sjsonp" + ++a, i = document.createElement("script"), e = null, d = function d(a) {
			var b;
	...
	this.Stripe.isDoubleLoaded || (b = {
	...
	}, g = /^(20\d|1223)$/, f = "invalid_json_response", d = function d(a, b, c) {
		return function () {
		...
		for (d in g) {
			j.call(g, d) && "setRequestHeader" in a && a.setRequestHeader(d, c._globalCustomHeaders[d]);
		}h = [];
		for (e in f) {
			j.call(f, e) && ("setRequestHeader" in a ? h.push(a.setRequestHeader(e, f[e])) : h.push(void 0));
		}return h;
	}, i = function i(a, b) {
		...
		return this.o = _a, e.apply(this, arguments);
	}, e = function e(a) {
		var b, d, e;
		return this.url = a.url, this.timeout = null, this._successHandler = function () {}, this._errorHandlers = [], this._completeHandlers = [], a.timeout && (this.timeout = setTimeout(function (a) {
			...
			return function (c, d) {
				var e;
				for (a.timeout && clearTimeout(b.timeout), b.timeout = null, e = []; b._completeHandlers.length > 0;) {
	...
	var a,
	    ...
	    _d,
	    e = {}.hasOwnProperty;
	this.Stripe.isDoubleLoaded || (a = function a(_a2) {
		return this.options = _a2, _a2.requestId = Stripe._callCount, _a2.endpoint = Stripe.endpoint, _a2.trackPerf = Stripe.trackPerf, this.iframeTimeout = setTimeout(function () {
			return Stripe._fallBackToOldStripeJsTechniques(), Stripe._iframePendingRequests[_a2.requestId] && (Stripe.request(Stripe._iframePendingRequests[_a2.requestId], !0), delete Stripe._iframePendingRequests[_a2.requestId]), Stripe._callCache[_a2.requestId] = function () {
				return Stripe.reportError("TimeoutEventualReturnError");
			};
		}, 1e4), Stripe._iframePendingRequests[_a2.requestId] = _a2, Stripe._callCache[_a2.requestId] = function (b) {
			return function () {
				return clearTimeout(b.iframeTimeout), delete Stripe._iframePendingRequests[_a2.requestId], _a2.success.apply(_a2, arguments), "function" == typeof _a2.complete ? _a2.complete("success", null, _a2) : void 0;
			};
		}(this), Stripe._callCount += 1, Stripe._socket.postMessage(Stripe.JSON.stringify(_a2));
		...
		onLoad: function onLoad() {
			return this._socketLoadTime = +new Date(), this.onError = function () {}, this.onAsyncInject = function () {}, clearTimeout(this.injectTimeout), this._socketAckTime ? this.loadTimeout ? (clearTimeout(this.loadTimeout), Stripe._iframeChannelComplete.call(Stripe, !0)) : Stripe.reportError("LoadDelayError", this._socketLoadTime - this._socketAckTime) : this.ackTimeout = setTimeout(function (a) {
				return function () {
					return a.onFrameAck = function () {}, clearTimeout(a.loadTimeout), _d("AckTimeoutError");
				};
			}(this), this.ackTimeoutDuration);
		},
		onError: function onError() {
			return this.onLoad = function () {}, this.onAsyncInject = function () {}, this.onFrameAck = function () {}, clearTimeout(this.ackTimeout), clearTimeout(this.injectTimeout), clearTimeout(this.loadTimeout), _d("IframeOnError");
		},
		onInternalError: function onInternalError(a) {
			var b, c, d;
			...
			for (b in d) {
				e.call(d, b) && (c = d[b], Stripe._callCache[c.requestId] = function () {}, delete Stripe._iframePendingRequests[c.requestId], Stripe.request(c, !0));
			}
		},
		onAsyncInject: function onAsyncInject(a) {
			return this.injectTimeout = setTimeout(function (a) {
				return function () {
					return a.onError = function () {}, a.onLoad = function () {}, a.onFrameAck = function () {}, clearTimeout(a.ackTimeout), clearTimeout(a.loadTimeout), _d("InjectTimeoutError");
				};
			}(this), this.ackTimeoutDuration);
		},
		onFrameAck: function onFrameAck(a) {
			return this._socketAckTime = +new Date(), clearTimeout(this.ackTimeout), clearTimeout(this.injectTimeout), this.onAsyncInject = function () {}, this.onError = function () {}, this.ackTimeout ? Stripe._iframeChannelComplete.call(Stripe, !0) : this._socketLoadTime ? (this.onLoad = function () {}, Stripe.reportError("AckDelayError", this._socketAckTime - this._socketLoadTime)) : this.loadTimeout = setTimeout(function (a) {
				return function () {
					return _d("LoadTimeoutError"), a.onLoad = function () {};
				};
			}(this), this.ackTimeoutDuration);
		}
	})));
	...
	this.Stripe.isDoubleLoaded || (this.Stripe.validator = {
		...
		}, birthYear: function birthYear(a, b) {
			var c;
		...
		}, bizTaxID: function bizTaxID(a, b) {
			var c, d, e, f, g, h, i, j;
		...
		}, bankAccountNumber: function bankAccountNumber(a, b) {
			if (!/^\d{1,17}$/.test(b)) return "Invalid bank account number";
		}, usRoutingNumber: function usRoutingNumber(a) {
			var b, c, d, e, f, g, h;
			if (!/^\d{9}$/.test(a)) return "Routing number must have 9 digits";
			for (f = 0, b = g = 0, h = a.length - 1; g <= h; b = g += 3) {
				c = 3 * parseInt(a.charAt(b), 10), d = 7 * parseInt(a.charAt(b + 1), 10), e = parseInt(a.charAt(b + 2), 10), f += c + d + e;
			}return 0 === f || f % 10 !== 0 ? "Invalid routing number" : void 0;
		}, caRoutingNumber: function caRoutingNumber(a) {
			if (!/^\d{5}\-\d{3}$/.test(a)) return "Invalid transit number";
		}, routingNumber: function routingNumber(a, b) {
			switch (a.toUpperCase()) {
				case "CA":
		...
		}, isElementOrId: function isElementOrId(a) {
			return "object" == (typeof a === "undefined" ? "undefined" : _typeof(a)) && null != a.appendChild || "string" == typeof a;
		}
	});
}.call(undefined);